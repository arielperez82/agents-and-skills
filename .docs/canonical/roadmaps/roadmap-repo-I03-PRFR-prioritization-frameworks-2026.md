...
| 3 | ap-product-manager and ap-product-director reference the new skill and updated workflows | Agent frontmatter and body updated; agents can invoke new tool |
| 4 | ap-senior-pm and ap-agile-coach understand portfolio context for risk and sprint planning | Agents reference portfolio allocation as input; delivery team can map sprint work to buckets |
