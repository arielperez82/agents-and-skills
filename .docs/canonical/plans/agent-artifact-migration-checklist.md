...
| senior-project-manager | portfolio status, risk assessments, RAG reports (reviewer/tracker — does not create roadmaps or charters) | Status/risk reports → `.docs/reports/report-repo-<topic>-<timeframe>.md`. Reviews existing canonical docs; marks backlog items done. |
