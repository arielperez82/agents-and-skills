...
| senior-project-manager | portfolio-roadmap.md, communication-plan.md, project-charter.md, risk-register.md, stakeholder-*.md, etc. | Charter/roadmap/backlog/plan under `.docs/canonical/`; reports → `.docs/reports/report-repo-<topic>-<timeframe>.md`. |
