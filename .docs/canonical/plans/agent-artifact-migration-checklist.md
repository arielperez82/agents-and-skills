...
| ap-product-analyst | improvement-plan.md, process-charter.md, sprint-backlog.md, stakeholder-analysis.md, etc. | Canonical plan/backlog/charter under `.docs/canonical/` with naming grammar. Session output → `.docs/reports/report-repo-session-<timeframe>.md` or keep session naming. |
| ap-ux-researcher | persona-research-plan.md, usability-test-plan.md | `.docs/canonical/plans/plan-repo-research-<subject>[-<timeframe>].md` or sections in plan. |
| ap-senior-pm | portfolio-roadmap.md, communication-plan.md, project-charter.md, risk-register.md, stakeholder-*.md, etc. | Charter/roadmap/backlog/plan under `.docs/canonical/`; reports → `.docs/reports/report-repo-<topic>-<timeframe>.md`. |
| ap-demand-gen-specialist | q4-demand-gen-campaign.md (from campaign-plan) | `.docs/canonical/plans/plan-repo-campaign-<timeframe>.md` (e.g. plan-repo-campaign-2026-q4.md). |
| ap-cto-advisor | board_email_template.md, ADR output | Report/ops under `.docs/reports/` or `.docs/canonical/ops/`. ADRs → `.docs/canonical/adrs/adr-YYYYMMDD-<subject>.md`. |
| ap-legacy-codebase-analyzer | assessment-report.md, executive-summary.md, modernization-plan.md, SUMMARY.md, ASSESSMENT_SUMMARY.md | Assessments → `.docs/canonical/assessments/assessment-repo-<subject>-<date>.md`; reports → `.docs/reports/report-repo-<topic>-<timeframe>.md`. |
| ap-seo-strategist | roadmap.md, $OUTPUT_DIR/roadmap.md | `.docs/canonical/roadmaps/roadmap-repo-seo-<timeframe>.md`. |
| ap-product-director | 2025-roadmap.md, q4-2025-roadmap.md, $YEAR-strategic-roadmap.md | `.docs/canonical/roadmaps/roadmap-repo-<scope>-<timeframe>.md`. |
| ap-code-reviewer | pr-123-review.md, pr-$PR-review.md | Commit-level: `.docs/canonical/reviews/review-repo-commit-<hash>.md`. |
| ap-observability-engineer | weekly-review.md, slo-definition.md, error-budget-policy.md, etc. | Weekly → `.docs/reports/report-repo-weekly-<timeframe>.md`; ops/sections → `.docs/canonical/ops/` or plan/assessment sections. |
...
| ap-incident-responder | preliminary-report.md, executive-alert.md, regulatory-requirements.md, data-breach-report.md | `.docs/reports/report-repo-incident-<id>-<topic>-<date>.md` or under `.docs/reports/` with naming grammar. |
| ap-java-engineer | security-report.md | `.docs/reports/report-repo-security-audit-<timeframe>.md`. |
| ap-data-engineer | $REPORT_DIR/summary.md | `.docs/reports/report-repo-pipeline-<timeframe>.md`. |
| ap-agent-author | agents/README.md, SKILL.md | Agent defs in `/agents/`; updates to `agents/README.md`; no coordination artifacts in /agents/. |
| ap-ui-designer | docs/components/$COMPONENT_NAME.md | `.docs/canonical/ops/` or `.docs/reports/` per type; or keep under docs/ if non-canonical. |
| ap-debugger | codebase-summary.md | `.docs/reports/report-repo-codebase-summary-<date>.md` or keep as tool output. |
| ap-agile-coach | retro-actions-sprint-25.md | `.docs/reports/report-repo-retro-<timeframe>.md` or section in plan/backlog. |
| ap-prompt-engineer | $OUTPUT_DIR/README.md | Output dir can stay for generated bundles; coordination → `.docs/`. |
| ap-content-creator | post.md, blog/*.md | Content artifacts; status/plan → `.docs/`. |
| ap-codebase-scout | _MAP.md, README.md, docs/codebase-summary.md | Read from `.docs/` when present; _MAP can live under `.docs/reports/` or project root per consumer. |
| ap-technical-writer | (see above) | (see above) |
