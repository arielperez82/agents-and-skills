...
Single continuous queue of **changes** (smallest independently valuable increments). Ordered by roadmap outcome and dependency. Implementers pull from here; execution is planned in a plan doc (optional).
...
- Roadmap: [roadmap-repo-I13-RCHG-review-changes-artifact-aware-2026.md](../roadmaps/roadmap-repo-I13-RCHG-review-changes-artifact-aware-2026.md)
