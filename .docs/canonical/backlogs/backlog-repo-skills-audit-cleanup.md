...
|----|--------|----------|-------|-------|
| S1 | ~~Decide ownership for `ux-designer` skill~~ **DONE** — created `ux-designer` agent; wired as `related-skill` on `ux-researcher` and `ui-designer` | Orphan skill | High | Resolved 2026-02-10. New agent `ux-designer` owns `ux-designer` as core skill. Also added as related-skill to ux-researcher and ui-designer. |
