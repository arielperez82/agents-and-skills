...
| I02-INNC-B12 | Update adr-writer, learn, docs-reviewer: when touching canonical docs, reference initiative; no creation of roadmap/backlog/plan without initiative fields | 3 | Agent compliance | Outcome 3 |
