...
| I02-INNC-B10 | Update senior-project-manager: roadmap/backlog/plan references use initiative code; require initiative + initiative_name in created artifacts | 3 | Agent compliance | Outcome 3 |
