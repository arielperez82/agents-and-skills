...
> **Note**: This agent was renamed from `ts-enforcer` to `cs-ts-enforcer` and moved to root `agents/` directory as part of the Guardians/Monitors/Validators cleanup (2026-01-26).
