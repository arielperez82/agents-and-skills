...
examples:
  -
    ...
    input: "TODO: Add example input for demand-gen-specialist"
...
The demand-gen-specialist agent bridges the gap between marketing strategy and measurable business outcomes, providing actionable insights on channel performance, conversion bottlenecks, and campaign effectiveness. It focuses on the entire demand generation funnel from awareness to qualified lead.
...
4. **Create Campaign Plan** - Use template to structure multi-channel approach
   ...
   ```bash
   cp ../skills/marketing-team/marketing-demand-acquisition/assets/campaign-plan.md {CANONICAL_ROOT}/plans/plan-repo-campaign-2026-q4.md
   ```
...
- [content-creator](content-creator.md) - Content creation for demand gen campaigns
- [product-marketer](product-marketer.md) - Product positioning and messaging (planned)
- [ap-growth-marketer](ap-growth-marketer.md) - Growth hacking and viral acquisition (planned)
