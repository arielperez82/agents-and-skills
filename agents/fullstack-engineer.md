...
- [devsecops-engineer](devsecops-engineer.md) - DevSecOps integration for secure infrastructure automation, CI/CD with security, and container orchestration
- [architect](architect.md) - System design, architectural patterns, and scalability planning
- [qa-engineer](qa-engineer.md) - Test automation, quality assurance, and test strategy
- [security-engineer](security-engineer.md) - Security audits, vulnerability assessment, and secure coding
- [code-reviewer](code-reviewer.md) - Code review automation and quality assessment
- [data-engineer](data-engineer.md) - Data pipeline development and database optimization
- [database-engineer](database-engineer.md) - Database design, query optimization, and performance tuning
