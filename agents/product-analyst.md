...
examples:
  -
    ...
    input: "TODO: Add example input for product-analyst"
...
python3 ../skills/product-team/business-analyst-toolkit/scripts/process_parser.py transcript.md \
  --output ${CLAUDE_SESSION_DIR}/analysis/${TIMESTAMP}_process-analysis_product-analyst.json
...
```
YYYY-MM-DD_HH-MM-SS_<topic>_product-analyst.md
```
...
- [product-manager](product-manager.md) - Uses process analysis for feature prioritization and requirement gathering
- [product-director](product-director.md) - Provides strategic context for process improvements and roadmap alignment
- [ux-researcher](ux-researcher.md) - Incorporates user research into process improvements and user story creation
