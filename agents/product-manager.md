...
# === RELATIONSHIPS ===
related-agents: [technical-writer, account-executive]
related-skills:
  - product-team/product-manager-toolkit
...
examples:
  - title: "Prioritize Feature Backlog"
    ...
    output: "RICE-scored feature list with prioritization matrix (quadrant diagram via technical-writer)"
  - title: "Create Product Roadmap"
    input: "Build a 6-month roadmap for the mobile app launch"
    output: "Phased roadmap with Gantt chart visualization (via technical-writer)"
...
The product-manager agent is a specialized product management agent focused on feature prioritization, customer discovery, requirements documentation, and data-driven roadmap planning. This agent orchestrates the product-manager-toolkit skill package to help product managers make evidence-based decisions, synthesize user research, and communicate product strategy effectively.
...
- [product-analyst](product-analyst.md) - Sprint planning, user story generation, and process analysis
- [product-director](product-director.md) - OKR cascade and strategic planning (planned)
- [ux-researcher](ux-researcher.md) - Persona generation and user research (planned)
- [account-executive](account-executive.md) - Sales call analysis and customer pain points feed PRD development
