...
examples:
  -
    ...
    input: "TODO: Add example input for computer-vision"
...
- [ml-engineer](ml-engineer.md) - MLOps infrastructure, model deployment pipelines, and experiment tracking
- [data-engineer](data-engineer.md) - Data pipeline development for large-scale dataset management
- [data-scientist](data-scientist.md) - Statistical analysis and feature engineering for vision tasks
- [prompt-engineer](prompt-engineer.md) - Vision-language models (CLIP, LLaVA) and multimodal AI systems
- [devsecops-engineer](devsecops-engineer.md) - DevSecOps integration for secure Kubernetes infrastructure and CI/CD for model deployment
- [backend-engineer](backend-engineer.md) - API development for model serving endpoints
- [fullstack-engineer](fullstack-engineer.md) - Web interfaces for vision system management
- [architect](architect.md) - System architecture design for scalable vision pipelines
