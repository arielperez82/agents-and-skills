...
> **Note**: This agent was renamed from `tdd-guardian` to `cs-tdd-guardian` and moved to root `agents/` directory as part of the Guardians/Monitors/Validators cleanup (2026-01-26).
...
- **Implementation Tools**: Use appropriate engineer agents (cs-frontend-engineer, cs-backend-engineer, etc.)
