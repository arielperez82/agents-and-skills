...
- [data-scientist](data-scientist.md) - Consumes data warehouse outputs for statistical analysis, feature engineering, and model training; collaborates on data quality requirements
- [ml-engineer](ml-engineer.md) - Integrates with data pipelines for ML feature stores and model training data; requires reliable, high-quality data infrastructure
- [architect](architect.md) - Defines overall system architecture including data platform strategy; ensures data systems integrate with broader technical architecture
- [devsecops-engineer](devsecops-engineer.md) - DevSecOps integration for secure data pipeline infrastructure (Kubernetes, Docker) with CI/CD deployment and security validation
- [backend-engineer](backend-engineer.md) - Provides source data via application databases and APIs; collaborates on CDC and event streaming patterns
- [database-engineer](database-engineer.md) - Database optimization for data pipelines, ETL processes, and data warehouse design
