...
# === RELATIONSHIPS ===
related-agents: [cs-implementation-planner, cs-brainstormer, cs-architect]
...
- `cs-implementation-planner` delegates all external research to you
- `cs-brainstormer` delegates all external research to you
- `cs-architect` may delegate technology evaluation research to you
