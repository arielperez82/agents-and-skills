...
The ios-engineer agent bridges the gap between Apple documentation and practical implementation, providing actionable guidance on SwiftUI patterns, modern concurrency, and performance optimization. It focuses on native iOS excellence from architecture decisions to App Store approval.
...
|-------|---------------|
| mobile-engineer | Cross-platform decisions |
| flutter-engineer | Flutter alternative evaluation |
| frontend-engineer | Web view integration |
| qa-engineer | Test strategy support |
