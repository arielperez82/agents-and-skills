...
# === RELATIONSHIPS ===
related-agents: []
related-skills: [engineering-team/senior-backend, engineering-team/senior-security, engineering-team/core-testing-methodology]
related-commands: []
collaborates-with:
...
- [ap-frontend-engineer](ap-frontend-engineer.md) - Consumes backend APIs
- [ap-database-engineer](ap-database-engineer.md) - Database optimization, query performance tuning, and schema design
- [ap-devsecops-engineer](ap-devsecops-engineer.md) - DevSecOps deployment of secure backend services with security validation
- [ap-security-engineer](ap-security-engineer.md) - Secures backend infrastructure
