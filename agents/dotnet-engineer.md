...
- [backend-engineer](backend-engineer.md) - General backend patterns, useful for non-.NET backends in polyglot systems
- [architect](architect.md) - System design and microservices architecture decisions
- [devsecops-engineer](devsecops-engineer.md) - DevSecOps integration for secure CI/CD pipelines and container deployment
