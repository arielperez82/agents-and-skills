...
- [backend-engineer](backend-engineer.md) - Backend API implementation
- [frontend-engineer](frontend-engineer.md) - GraphQL client integration
- [architect](architect.md) - System architecture decisions - provides high-level API technology evaluation and delegates GraphQL-specific details
- [devsecops-engineer](devsecops-engineer.md) - DevSecOps integration for secure deployment and infrastructure
