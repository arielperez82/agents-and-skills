...
examples:
  -
    ...
    input: "TODO: Add example input for ap-computer-vision"
...
- [ap-ml-engineer](ap-ml-engineer.md) - MLOps infrastructure, model deployment pipelines, and experiment tracking
- [ap-data-engineer](ap-data-engineer.md) - Data pipeline development for large-scale dataset management
- [ap-data-scientist](ap-data-scientist.md) - Statistical analysis and feature engineering for vision tasks
- [ap-prompt-engineer](ap-prompt-engineer.md) - Vision-language models (CLIP, LLaVA) and multimodal AI systems
- [ap-devsecops-engineer](ap-devsecops-engineer.md) - DevSecOps integration for secure Kubernetes infrastructure and CI/CD for model deployment
- [ap-backend-engineer](ap-backend-engineer.md) - API development for model serving endpoints
- [ap-fullstack-engineer](ap-fullstack-engineer.md) - Web interfaces for vision system management
- [ap-architect](ap-architect.md) - System architecture design for scalable vision pipelines
