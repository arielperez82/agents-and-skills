...
- [devsecops-engineer](devsecops-engineer.md) - DevSecOps integration for security practices, secure pipeline integration, and infrastructure security
...
- [security-assessor](security-assessor.md) - Assesses code or diffs and produces security findings report with criticality; hands off remediation to this agent
