...
- [security-assessor](security-assessor.md) - Delegates security assessment of changes; produces findings report with criticality for integration into review
- [refactor-assessor](refactor-assessor.md) - Assesses refactoring opportunities, identifies knowledge duplication, and evaluates semantic vs structural similarity during code reviews
- [tdd-reviewer](tdd-reviewer.md) - Verifies TDD compliance and test structure during code reviews
- [qa-engineer](qa-engineer.md) - Provides test automation and quality metrics assessment during reviews
