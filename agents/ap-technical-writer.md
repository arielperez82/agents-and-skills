...
**Escalate to [ap-code-reviewer](ap-code-reviewer.md) when:**
...
**Escalate to [ap-architect](ap-architect.md) when:**
...
**Escalate to [ap-devsecops-engineer](ap-devsecops-engineer.md) when:**
...
**Collaborate with [ap-backend-engineer](ap-backend-engineer.md) for:**
- API documentation accuracy verification
- Authentication flow documentation
- Database schema documentation
- Performance characteristics documentation

**Collaborate with [ap-frontend-engineer](ap-frontend-engineer.md) for:**
- Client SDK documentation
- Integration examples from frontend perspective
- UI component documentation

**Collaborate with [ap-product-manager](../ap-product-manager.md) for:**
...
- **[ap-code-reviewer](ap-code-reviewer.md)** - Ensures code quality supports clear documentation, identifies user-facing changes requiring docs
- **[ap-architect](ap-architect.md)** - Provides architectural context for system documentation, reviews technical accuracy
- **[ap-backend-engineer](ap-backend-engineer.md)** - Validates API documentation accuracy, provides implementation details for docs
- **[ap-devsecops-engineer](ap-devsecops-engineer.md)** - DevSecOps integration for secure documentation deployment with quality and security checks in CI/CD
- **[ap-frontend-engineer](ap-frontend-engineer.md)** - Contributes client-side integration examples, validates SDK documentation
