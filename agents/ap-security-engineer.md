...
# === RELATIONSHIPS ===
related-agents: []
related-skills: [engineering-team/senior-security, engineering-team/core-testing-methodology]
related-commands: []
collaborates-with:
...
- [ap-architect](ap-architect.md) - Provides system design context for security architecture decisions and threat modeling
