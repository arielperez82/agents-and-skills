...
examples:
  -
    ...
    input: "TODO: Add example input for ap-data-scientist"
...
- [ap-ml-engineer](ap-ml-engineer.md) - Complements data science with MLOps infrastructure for model deployment, monitoring, and production serving
- [ap-data-engineer](ap-data-engineer.md) - Provides upstream data pipeline infrastructure ensuring clean, reliable datasets for analysis
- [ap-computer-vision-engineer](ap-computer-vision-engineer.md) - Specialized image/video analysis when working with visual data
- [ap-prompt-engineer](ap-prompt-engineer.md) - LLM integration for NLP tasks and text feature engineering
