...
|-------|---------------|
| ios-engineer | Deep iOS/Swift expertise needed |
| flutter-engineer | Deep Flutter/Dart expertise needed |
| frontend-engineer | Web frontend integration |
| devsecops-engineer | DevSecOps CI/CD pipeline setup |
