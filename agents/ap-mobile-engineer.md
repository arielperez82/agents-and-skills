...
|-------|---------------|
| ap-ios-engineer | Deep iOS/Swift expertise needed |
| ap-flutter-engineer | Deep Flutter/Dart expertise needed |
| ap-frontend-engineer | Web frontend integration |
| ap-devsecops-engineer | DevSecOps CI/CD pipeline setup |
