...
examples:
  -
    ...
    input: "TODO: Add example input for prompt-engineer"
...
- [ml-engineer](ml-engineer.md) - Complements agent orchestration with model deployment and MLOps infrastructure
- [data-engineer](data-engineer.md) - Provides data pipeline integration for RAG document processing and embedding generation
