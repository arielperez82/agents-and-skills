...
examples:
  -
    ...
    input: "TODO: Add example input for ap-prompt-engineer"
...
- [ap-ml-engineer](ap-ml-engineer.md) - Complements agent orchestration with model deployment and MLOps infrastructure
- [ap-data-engineer](ap-data-engineer.md) - Provides data pipeline integration for RAG document processing and embedding generation
- [ap-senior-architect](ap-senior-architect.md) - Offers system architecture guidance for scaling LLM applications to production traffic
