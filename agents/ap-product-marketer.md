...
examples:
  -
    ...
    input: "TODO: Add example input for ap-product-marketer"
...
- [ap-content-creator](ap-content-creator.md) - Creates content for positioning and GTM campaigns
- [ap-demand-gen-specialist](ap-demand-gen-specialist.md) - Executes acquisition campaigns based on PMM positioning
- [ap-ceo-advisor](../c-level/ap-ceo-advisor.md) - Strategic planning context for market expansion
- [ap-product-manager](ap-product-manager.md) - Product roadmap prioritization based on competitive intelligence (planned)
