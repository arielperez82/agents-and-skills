...
# === RELATIONSHIPS ===
related-agents: [backend-engineer, architect, devsecops-engineer]
...
- [backend-engineer](backend-engineer.md) - General backend patterns, useful for non-Java backends in polyglot systems
- [architect](architect.md) - System design and microservices architecture decisions
- [devsecops-engineer](devsecops-engineer.md) - DevSecOps integration for secure CI/CD pipelines and Kubernetes deployment
- [security-engineer](security-engineer.md) - Security audits and penetration testing
- [qa-engineer](qa-engineer.md) - Test strategy and quality assurance
