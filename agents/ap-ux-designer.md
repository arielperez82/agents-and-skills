...
This agent sits between research (ap-ux-researcher) and design systems (ap-ui-designer) in the design pipeline. It consumes research insights and personas to produce wireframes, user flows, and interaction specifications. It hands off to ap-ui-designer for component library integration and to frontend engineers for implementation.
...
- [ap-ux-researcher](ap-ux-researcher.md) - Provides research insights, personas, and usability test results that inform design decisions
- [ap-ui-designer](ap-ui-designer.md) - Takes wireframes and specs to build reusable design system components and tokens
- [ap-frontend-engineer](ap-frontend-engineer.md) - Implements the designs using the component library and design tokens
- [ap-product-manager](ap-product-manager.md) - Provides requirements, acceptance criteria, and feature priorities
