...
examples:
  - title: "Generate OKR Cascade"
    ...
    output: "OKR cascade with company, team, and individual objectives (mindmap via ap-technical-writer)"
  - title: "Build Product Roadmap"
    input: "Create 2025 product roadmap with quarterly milestones"
    output: "Strategic roadmap with timeline visualization (via ap-technical-writer)"
...
- [ap-product-manager](ap-product-manager.md) - Tactical feature prioritization using RICE, receives strategic context from roadmap planning
- [ap-product-analyst](ap-product-analyst.md) - Sprint planning, user stories, and process analysis, translates strategic initiatives into sprint-ready work
