...
- **[cs-devsecops-engineer](cs-devsecops-engineer.md)** - DevSecOps modernization of CI/CD pipelines, secure infrastructure migration, deployment automation, security monitoring setup
