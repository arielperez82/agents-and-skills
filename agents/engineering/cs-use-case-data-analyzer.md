...
> **Note**: This agent was renamed from `use-case-data-patterns` to `cs-use-case-data-analyzer` and moved to `agents/engineering/` as part of the agent standardization effort (2026-01-28). It remains functionally identical but now follows the cs-* naming convention and proper frontmatter structure.
