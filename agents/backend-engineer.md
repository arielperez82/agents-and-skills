...
- [database-engineer](database-engineer.md) - Database optimization, query performance tuning, and schema design
- [devsecops-engineer](devsecops-engineer.md) - DevSecOps deployment of secure backend services with security validation
