...
python ../skills/senior-backend/scripts/api_scaffolder.py PROJECT_NAME --type rest|graphql --stack express-typescript

# Database Migration Management - Version control for database schemas
python ../skills/senior-backend/scripts/database_migration_tool.py create|migrate|rollback|status

# API Load Testing - Performance benchmarking and capacity planning
python ../skills/senior-backend/scripts/api_load_tester.py ENDPOINT --users NUM --requests NUM
```
...
1. **Scaffold API Project**
   ...
   python ../skills/senior-backend/scripts/api_scaffolder.py my-api --type rest --stack express-typescript --auth
   ```
...
**Reference:** See `../skills/senior-backend/references/templates.md` for complete project structure and configuration examples.
...
1. **Scaffold GraphQL API**
   ...
   ```bash
   python ../skills/senior-backend/scripts/api_scaffolder.py graphql-api --type graphql --stack apollo-typescript
   ```
...
**Reference:** See `../skills/senior-backend/references/frameworks.md` for GraphQL patterns and DataLoader implementation details.
...
3. **Create Migration**
   ...
   ```bash
   python ../skills/senior-backend/scripts/database_migration_tool.py create "add_optimized_schema"
   ```
...
5. **Run Migration**
   ...
   ```bash
   python ../skills/senior-backend/scripts/database_migration_tool.py migrate
   ```
...
6. **Verify Schema**
   ...
   python ../skills/senior-backend/scripts/database_migration_tool.py status
...
**Reference:** See `../skills/senior-backend/references/templates.md` for Prisma schema patterns and optimization strategies.
...
1. **Establish Baseline Performance**
   ...
   python ../skills/senior-backend/scripts/api_load_tester.py \
...
**Reference:** See `../skills/senior-backend/references/frameworks.md` for caching strategies and performance optimization patterns.
...
**Reference:** `../skills/senior-backend/references/frameworks.md` - Microservices Patterns section
...
**Reference:** `../skills/senior-backend/references/templates.md` - Authentication Service templates
...
**Reference:** `../skills/senior-backend/references/tools.md` - Database Migration Tool section
...
cd my-project
python3 ../skills/senior-backend/scripts/api_scaffolder.py \
  --name UserAPI \
...
python3 ../skills/senior-backend/scripts/performance_analyzer.py \
  --endpoint /api/users \
  --load-test 1000 \
...
- [frontend-engineer](frontend-engineer.md) - Consumes backend APIs
- [devops-engineer](devops-engineer.md) - Deploys backend services
- [security-engineer](security-engineer.md) - Secures backend infrastructure
...
- `../skills/senior-backend/SKILL.md` - Complete skill overview
- `../skills/senior-backend/references/frameworks.md` - Architecture patterns
- `../skills/senior-backend/references/templates.md` - Code templates
- `../skills/senior-backend/references/tools.md` - Tool documentation
