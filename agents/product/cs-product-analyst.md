...
examples:
  -
    ...
    input: "TODO: Add example input for cs-product-analyst"
...
python3 ../../skills/product-team/business-analyst-toolkit/scripts/process_parser.py transcript.md \
  --output ${CLAUDE_SESSION_DIR}/analysis/${TIMESTAMP}_process-analysis_cs-product-analyst.json
...
```
YYYY-MM-DD_HH-MM-SS_<topic>_cs-product-analyst.md
```
...
- [cs-product-director](cs-product-director.md) - Provides strategic context for process improvements and roadmap alignment
- [cs-ux-researcher](cs-ux-researcher.md) - Incorporates user research into process improvements and user story creation
