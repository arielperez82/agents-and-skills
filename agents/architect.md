...
# === RELATIONSHIPS ===
related-skills: [senior-architect]
related-commands: []
orchestrates:
...
2. **Project Architect**
   ...
   - **Path:** `../skills/senior-architect/scripts/project_architect.py`
   - **Usage:** `python ../skills/senior-architect/scripts/project_architect.py --input target_path --verbose`
   - **Features:**
...
3. **Dependency Analyzer**
   ...
   - **Path:** `../skills/senior-architect/scripts/dependency_analyzer.py`
   - **Usage:** `python ../skills/senior-architect/scripts/dependency_analyzer.py --input project_path`
   - **Features:**
...
1. **Architecture Patterns**
   - **Location:** `../skills/senior-architect/references/architecture_patterns.md`
...
2. **System Design Workflows**
   - **Location:** `../skills/senior-architect/references/system_design_workflows.md`
...
3. **Tech Decision Guide**
   - **Location:** `../skills/senior-architect/references/tech_decision_guide.md`
...
2. **Select Architecture Pattern** - Choose appropriate pattern based on requirements:
   ...
   cat ../skills/senior-architect/references/architecture_patterns.md
   ```
...
4. **Generate Architecture Diagrams** - Create visual documentation:
   ...
   ```bash
   python ../skills/senior-architect/scripts/architecture_diagram_generator.py --input ./project --output text
   ```
...
python ../skills/senior-architect/scripts/architecture_diagram_generator.py --input ./src --output json --file architecture-docs/system-design.json
cat ../skills/senior-architect/references/architecture_patterns.md > architecture-docs/patterns-reference.md
...
1. **Run Project Architect Analysis** - Execute comprehensive codebase analysis:
   ...
   ```bash
   python ../skills/senior-architect/scripts/project_architect.py --input ./project --verbose > architecture-audit.txt
   ```
...
3. **Analyze Dependencies** - Identify coupling issues:
   ...
   ```bash
   python ../skills/senior-architect/scripts/dependency_analyzer.py --input ./project --output json > dependency-analysis.json
   ```
...
python ../skills/senior-architect/scripts/project_architect.py --input . --verbose --output json --file audit-report.json
python ../skills/senior-architect/scripts/dependency_analyzer.py --input . --output csv --file dependency-graph.csv
...
2. **Research Technology Options** - Review reference guide:
   ...
   ```bash
   cat ../skills/senior-architect/references/tech_decision_guide.md
   ```
...
4. **Analyze Current Architecture** - Assess migration feasibility:
   ...
   ```bash
   python ../skills/senior-architect/scripts/project_architect.py --input . --verbose
   ```
...
cat ../skills/senior-architect/references/tech_decision_guide.md > tech-evaluation/decision-framework.md
python ../skills/senior-architect/scripts/project_architect.py --input . --output json > tech-evaluation/current-state.json
...
python ../skills/senior-architect/scripts/project_architect.py --input . --verbose --file performance-analysis.txt
cat ../skills/senior-architect/references/architecture_patterns.md | grep -A 20 "Resilience Patterns"
...
python ../skills/senior-architect/scripts/project_architect.py \
  --input "$PROJECT_PATH" \
  --output json \
...
python ../skills/senior-architect/scripts/dependency_analyzer.py \
  --input "$PROJECT_PATH" \
  --output json \
...
python ../skills/senior-architect/scripts/architecture_diagram_generator.py \
  --input "$PROJECT_PATH" \
  --output text \
...
- [backend-engineer](backend-engineer.md) - Implements backend services following architecture patterns and guidelines
- [frontend-engineer](frontend-engineer.md) - Implements frontend applications following architecture patterns and component design
- [fullstack-engineer](fullstack-engineer.md) - Implements end-to-end features following full-stack architecture patterns
- [devops-engineer](devops-engineer.md) - Implements infrastructure and deployment pipelines based on architecture design
- [security-engineer](security-engineer.md) - Validates security patterns and implements security requirements in architecture

## Collaboration: Architecture Diagram Generation

**For architecture diagrams, architect delegates to docs-guardian's Mermaid Diagram Generator.**

This follows the complementary design principle - architecture design stays with architect, while diagram generation is a technical-writer capability.

### Collaboration Workflow

1. **architect designs** the system architecture (components, layers, data flow)
2. **architect creates** JSON/YAML definition of the architecture
3. **docs-guardian generates** Mermaid diagrams using mermaid_diagram_generator.py
4. **architect reviews** and embeds diagrams in documentation

### Example: Microservices Architecture Diagram

**Step 1: architect creates architecture definition**
...
```json
{
  ...
  "layers": [
    {
      "name": "API Gateway",
      "components": [{ "id": "gateway", "label": "API Gateway", "type": "service" }]
    },
    {
      "name": "Services",
      "components": [
...
```bash
python ../skills/technical-writer/scripts/mermaid_diagram_generator.py \
  --type architecture \
...
- **Skill Documentation:** [../skills/senior-architect/SKILL.md](../skills/senior-architect/SKILL.md)
---
