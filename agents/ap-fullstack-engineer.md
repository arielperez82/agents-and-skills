...
# === RELATIONSHIPS ===
related-agents: []
related-skills: [engineering-team/avoid-feature-creep, engineering-team/mcp-builder, engineering-team/vercel-deploy-claimable, engineering-team/senior-fullstack, engineering-team/senior-security, engineering-team/core-testing-methodology]
related-commands: []
collaborates-with:
...
The ap-fullstack-engineer agent is a comprehensive fullstack development specialist that orchestrates the senior-fullstack skill package to deliver end-to-end application development solutions. This agent combines frontend expertise (React, Next.js, Vue), backend capabilities (Node.js, Express, GraphQL), and infrastructure management (Docker, Kubernetes, CI/CD) to guide developers through complete project lifecycles from initial scaffolding to production deployment.
...
- [ap-frontend-engineer](ap-frontend-engineer.md) - Specialized frontend development with React/Vue expertise
- [ap-backend-engineer](ap-backend-engineer.md) - Backend API development and microservices architecture
- [ap-devsecops-engineer](ap-devsecops-engineer.md) - DevSecOps integration for secure infrastructure automation, CI/CD with security, and container orchestration
- [ap-architect](ap-architect.md) - System design, architectural patterns, and scalability planning
- [ap-qa-engineer](ap-qa-engineer.md) - Test automation, quality assurance, and test strategy
- [ap-security-engineer](ap-security-engineer.md) - Security audits, vulnerability assessment, and secure coding
- [ap-code-reviewer](ap-code-reviewer.md) - Code review automation and quality assessment
- [ap-data-engineer](ap-data-engineer.md) - Data pipeline development and database optimization
- [ap-database-engineer](ap-database-engineer.md) - Database design, query optimization, and performance tuning
