...
# === RELATIONSHIPS ===
related-agents: []
related-skills: [engineering-team/senior-data-engineer, engineering-team/core-testing-methodology]
related-commands: []
collaborates-with:
...
- [ap-data-scientist](ap-data-scientist.md) - Consumes data warehouse outputs for statistical analysis, feature engineering, and model training; collaborates on data quality requirements
- [ap-ml-engineer](ap-ml-engineer.md) - Integrates with data pipelines for ML feature stores and model training data; requires reliable, high-quality data infrastructure
- [ap-architect](ap-architect.md) - Defines overall system architecture including data platform strategy; ensures data systems integrate with broader technical architecture
- [ap-devsecops-engineer](ap-devsecops-engineer.md) - DevSecOps integration for secure data pipeline infrastructure (Kubernetes, Docker) with CI/CD deployment and security validation
- [ap-backend-engineer](ap-backend-engineer.md) - Provides source data via application databases and APIs; collaborates on CDC and event streaming patterns
- [ap-database-engineer](ap-database-engineer.md) - Database optimization for data pipelines, ETL processes, and data warehouse design
