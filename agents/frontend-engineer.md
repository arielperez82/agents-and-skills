...
- [ui-designer](../ui-designer.md) - Design system development and design token management
- [qa-engineer](qa-engineer.md) - Test automation and quality assurance for frontend applications
- [devsecops-engineer](devsecops-engineer.md) - DevSecOps integration for secure CI/CD pipelines and deployment with security validation
