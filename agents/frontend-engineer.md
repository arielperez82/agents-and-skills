...
The frontend-engineer agent bridges the gap between design mockups and production-ready implementation, providing actionable guidance on component scaffolding, bundle optimization, and UI best practices. It focuses on the complete frontend development cycle from project setup to performance tuning.

## Skill Integration

**Skill Location:** `../skills/senior-frontend/`

### Python Tools

1. **Component Generator**
   - **Purpose:** Automated React component generation with TypeScript, tests, and Storybook stories
   - **Path:** `../skills/senior-frontend/scripts/component_generator.py`
   - **Usage:** `python ../skills/senior-frontend/scripts/component_generator.py Button --complete`
   - **Features:**
...
2. **Bundle Analyzer**
   ...
   - **Path:** `../skills/senior-frontend/scripts/bundle_analyzer.py`
   - **Usage:** `python ../skills/senior-frontend/scripts/bundle_analyzer.py .next/ --verbose`
   - **Features:**
...
3. **Frontend Scaffolder**
   ...
   - **Path:** `../skills/senior-frontend/scripts/frontend_scaffolder.py`
   - **Usage:** `python ../skills/senior-frontend/scripts/frontend_scaffolder.py my-app --framework nextjs --complete`
   - **Features:**
...
1. **Architecture Frameworks**
   - **Location:** `../skills/senior-frontend/references/frameworks.md`
...
2. **Implementation Templates**
   - **Location:** `../skills/senior-frontend/references/templates.md`
...
3. **Python Tools Guide**
   - **Location:** `../skills/senior-frontend/references/tools.md`
...
1. **Scaffold Project Structure** - Initialize component library foundation
   ...
   ```bash
   python ../skills/senior-frontend/scripts/frontend_scaffolder.py ui-library --framework nextjs --complete
   cd ui-library
   npm install
   ```
...
2. **Generate Atom Components** - Create foundational UI elements
   ...
   python ../skills/senior-frontend/scripts/component_generator.py Button --complete --level atom

   # Input component with validation
   python ../skills/senior-frontend/scripts/component_generator.py Input --complete --level atom

   # Label component
   python ../skills/senior-frontend/scripts/component_generator.py Label --complete --level atom
   ```
...
3. **Generate Molecule Components** - Compose atoms into functional units
   ...
   python ../skills/senior-frontend/scripts/component_generator.py FormField --complete --level molecule

   # SearchBar with Button
   python ../skills/senior-frontend/scripts/component_generator.py SearchBar --complete --level molecule
   ```
...
4. **Generate Organism Components** - Build complex UI sections
   ...
   python ../skills/senior-frontend/scripts/component_generator.py LoginForm --complete --level organism

   # Navigation using multiple atoms/molecules
   python ../skills/senior-frontend/scripts/component_generator.py Navigation --complete --level organism
   ```
...
python ../skills/senior-frontend/scripts/frontend_scaffolder.py design-system --framework nextjs --complete
cd design-system
python ../skills/senior-frontend/scripts/component_generator.py Button --complete --level atom
python ../skills/senior-frontend/scripts/component_generator.py Input --complete --level atom
python ../skills/senior-frontend/scripts/component_generator.py FormField --complete --level molecule
...
2. **Analyze Bundle Composition** - Identify optimization opportunities
   ...
   ```bash
   python ../skills/senior-frontend/scripts/bundle_analyzer.py .next/ --verbose
   ```
...
7. **Re-analyze and Compare** - Verify improvements
   ...
   ```bash
   npm run build
   python ../skills/senior-frontend/scripts/bundle_analyzer.py .next/ --compare baseline-report.html
   ```
...
npm run build
python ../skills/senior-frontend/scripts/bundle_analyzer.py .next/ --verbose > baseline-report.txt
...
# Re-analyze
npm run build
python ../skills/senior-frontend/scripts/bundle_analyzer.py .next/ --verbose > optimized-report.txt
...
1. **Review Accessibility Requirements** - Understand WCAG standards
   ...
   ```bash
   cat ../skills/senior-frontend/references/frameworks.md | grep -A 20 "Accessibility"
   ```
...
2. **Generate Accessible Components** - Use semantic HTML and ARIA labels
   ...
   python ../skills/senior-frontend/scripts/component_generator.py AccessibleButton --complete
   ```
...
python ../skills/senior-frontend/scripts/component_generator.py AccessibleModal --complete
python ../skills/senior-frontend/scripts/component_generator.py AccessibleForm --complete
...
1. **Scaffold Next.js Project** - Initialize with complete configuration
   ...
   ```bash
   python ../skills/senior-frontend/scripts/frontend_scaffolder.py my-nextjs-app --framework nextjs --complete
   cd my-nextjs-app
   npm install
   ```
...
2. **Implement Layout System** - Create reusable layouts
   ...
   python ../skills/senior-frontend/scripts/component_generator.py DashboardLayout --type functional --complete

   # Generate auth layout
   python ../skills/senior-frontend/scripts/component_generator.py AuthLayout --type functional --complete
   ```
...
4. **Add Client Components** - Interactive UI elements
   ...
   python ../skills/senior-frontend/scripts/component_generator.py InteractiveChart --complete
   ```
...
7. **Add Authentication** - JWT or NextAuth implementation
   ...
   ```bash
   cat ../skills/senior-frontend/references/templates.md | grep -A 30 "Authentication"
   ```
...
python ../skills/senior-frontend/scripts/frontend_scaffolder.py ecommerce-app --framework nextjs --complete
cd ecommerce-app
npm install

# Generate layouts and components
python ../skills/senior-frontend/scripts/component_generator.py ProductCard --complete
python ../skills/senior-frontend/scripts/component_generator.py ShoppingCart --complete
...
python ../skills/senior-frontend/scripts/component_generator.py Tooltip --complete --level atom
python ../skills/senior-frontend/scripts/component_generator.py Dropdown --complete --level molecule
python ../skills/senior-frontend/scripts/component_generator.py DataTable --complete --level organism
...
npm run build
python ../skills/senior-frontend/scripts/bundle_analyzer.py .next/ --verbose > bundle-report.txt
...
- [backend-engineer](backend-engineer.md) - API development and backend integration for fullstack features
- [fullstack-engineer](fullstack-engineer.md) - End-to-end development combining frontend and backend
- [tdd-engineer](tdd-engineer.md) - Test automation and quality assurance for frontend applications
- [devops-engineer](devops-engineer.md) - CI/CD pipelines and deployment automation

## References

- **Skill Documentation:** [../skills/senior-frontend/SKILL.md](../skills/senior-frontend/SKILL.md)
- 
---
