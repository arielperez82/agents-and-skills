...
- [ap-backend-engineer](ap-backend-engineer.md) - General backend patterns, useful for non-Java backends in polyglot systems
- [ap-architect](ap-architect.md) - System design and microservices architecture decisions
- [ap-devsecops-engineer](ap-devsecops-engineer.md) - DevSecOps integration for secure CI/CD pipelines and Kubernetes deployment
