...
examples:
  -
    ...
    input: "TODO: Add example input for ap-agile-coach"
...
- [ap-senior-pm](ap-senior-pm.md) - Senior PM handles strategic project oversight and risk management; Agile Coach focuses on team dynamics and collaboration
- [ap-product-analyst](ap-product-analyst.md) - Product Analyst prioritizes backlog; Agile Coach facilitates collaborative refinement and planning ceremonies
