...
> **Note**: This agent was renamed from `tpp-guardian` to `cs-tpp-guardian` and moved to root `agents/` directory as part of the Guardians/Monitors/Validators cleanup (2026-01-26).
