...
**Architecture Decisions:** For significant GraphQL architecture decisions like federation strategy selection, invoke ap-adr-writer to document the rationale and alternatives.
...
- [ap-backend-engineer](ap-backend-engineer.md) - Backend API implementation
- [ap-frontend-engineer](ap-frontend-engineer.md) - GraphQL client integration
- [ap-architect](ap-architect.md) - System architecture decisions - provides high-level API technology evaluation and delegates GraphQL-specific details
- [ap-devsecops-engineer](ap-devsecops-engineer.md) - DevSecOps integration for secure deployment and infrastructure
- [ap-adr-writer](ap-adr-writer.md) - Documents GraphQL architecture decisions and schema design choices
