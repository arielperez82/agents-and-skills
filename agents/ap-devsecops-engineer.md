...
# === RELATIONSHIPS ===
related-agents: []
related-skills: [engineering-team/senior-devops, engineering-team/core-testing-methodology]
related-commands: []
collaborates-with:
...
The ap-devsecops-engineer agent is a comprehensive DevSecOps specialist that orchestrates both the senior-devops and senior-secops skill packages to deliver secure infrastructure automation, CI/CD pipelines with security integration, container orchestration with security controls, vulnerability management, and compliance automation. This agent combines infrastructure as code expertise (Terraform, CloudFormation), continuous integration/deployment capabilities (GitHub Actions, CircleCI, Jenkins), container orchestration knowledge (Docker, Kubernetes), security scanning automation, vulnerability assessment, and compliance validation to guide teams through complete secure DevOps lifecycles from secure pipeline setup to production security monitoring.
...
# Generate NewRelic dashboards using ap-observability-engineer tools
# See: ap-observability-engineer.md Workflow 5 for complete NewRelic setup
```
...
- [ap-backend-engineer](ap-backend-engineer.md) - Provides application code that DevOps pipelines deploy and monitor
- [ap-frontend-engineer](ap-frontend-engineer.md) - Frontend applications requiring specialized build and deployment pipelines
- [ap-fullstack-engineer](ap-fullstack-engineer.md) - Full-stack applications needing end-to-end deployment orchestration
- [ap-architect](ap-architect.md) - System architecture decisions that inform infrastructure design patterns
- [ap-security-engineer](ap-security-engineer.md) - Security scanning and compliance integration into CI/CD pipelines
- [ap-incident-responder](ap-incident-responder.md) - Security incident response coordination and emergency rollback
- [ap-qa-engineer](ap-qa-engineer.md) - Test automation integration into deployment pipelines
- [ap-legacy-codebase-analyzer](ap-legacy-codebase-analyzer.md) - Security vulnerability scanning and remediation planning for legacy systems during infrastructure modernization
