...
examples:
  -
    ...
    input: "TODO: Add example input for data-scientist"
...
- [ml-engineer](ml-engineer.md) - Complements data science with MLOps infrastructure for model deployment, monitoring, and production serving
- [data-engineer](data-engineer.md) - Provides upstream data pipeline infrastructure ensuring clean, reliable datasets for analysis
- [computer-vision-engineer](computer-vision-engineer.md) - Specialized image/video analysis when working with visual data
- [prompt-engineer](prompt-engineer.md) - LLM integration for NLP tasks and text feature engineering
