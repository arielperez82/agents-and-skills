...
- [ ] TypeScript types generated after migration (if applicable)

**Type Generation:**
- [ ] TypeScript types generated after migration: `supabase gen types typescript --local > src/types/database.types.ts`
