...
The ui-designer agent is a specialized design systems agent focused on design token generation, component library management, design system documentation, and scalable design infrastructure development. This agent orchestrates the ui-design-system skill package to help UI designers and design teams build consistent, maintainable, and accessible design systems that scale across products and platforms.
...
- [ux-researcher](ux-researcher.md) - User research insights inform design system patterns and component needs
- [product-analyst](product-analyst.md) - User stories reference design system components for implementation clarity
- [product-manager](product-manager.md) - Feature requirements specify design system usage for consistency
