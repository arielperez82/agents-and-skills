...
The ml-engineer agent is a specialized machine learning engineering specialist that orchestrates the senior-ml-engineer skill package to deliver production-grade ML systems. This agent combines deep learning expertise (PyTorch, TensorFlow), MLOps best practices (MLflow, model monitoring), and modern LLM integration capabilities (RAG systems, fine-tuning) to guide ML engineers through the complete model lifecycle from experimentation to production deployment at scale.
...
- [data-scientist](data-scientist.md) - Statistical analysis, feature engineering, experiment design for model development
- [data-engineer](data-engineer.md) - Data pipelines, feature stores, and data infrastructure for ML training
- [computer-vision-engineer](computer-vision-engineer.md) - Specialized computer vision model training and deployment
- [prompt-engineer](prompt-engineer.md) - LLM prompt optimization, RAG system tuning, and multi-agent orchestration
- [devsecops-engineer](devsecops-engineer.md) - DevSecOps integration for secure CI/CD pipelines, Kubernetes orchestration, and infrastructure automation
- [backend-engineer](backend-engineer.md) - API development for model serving endpoints
- [architect](architect.md) - ML system architecture, scalability planning, infrastructure design
- [security-engineer](security-engineer.md) - ML model security, API security, data privacy compliance
- [database-engineer](database-engineer.md) - Database optimization for ML feature stores, model serving databases, and vector databases
