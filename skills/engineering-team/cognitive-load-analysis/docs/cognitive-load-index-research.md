...
1. Skelton, M. and Pais, M. (2019). "Team Topologies." IT Revolution. Referenced via: [IT Revolution - Team Cognitive Load](https://itrevolution.com/articles/cognitive-load/), [InfoQ](https://www.infoq.com/news/2019/07/team-topologies-cognitive-loa/)

2. Martin, R.C. (2008). "Clean Code: A Handbook of Agile Software Craftsmanship." Referenced via: [GitHub Gist Summary](https://gist.github.com/wojteklu/73c6914cc446146b8b533c0988cf8d29), [Martin Fowler - Function Length](https://martinfowler.com/bliki/FunctionLength.html)

3. GetDX (2024). "How cognitive complexity creates hidden friction in engineering organizations." Referenced via: [GetDX Blog](https://getdx.com/blog/cognitive-complexity/)

4. Sourcery.ai (2024). "Maintainability Index - What is it and where does it fall short?" Referenced via: [Sourcery.ai Blog](https://www.sourcery.ai/blog/maintainability-index)

5. Microsoft Learn. "Code Metrics - Maintainability Index Range and Meaning." Referenced via: [Microsoft Learn](https://learn.microsoft.com/en-us/visualstudio/code-quality/code-metrics-maintainability-index-range-and-meaning?view=vs-2022)

6. NDepend. "100+ .NET and C# Code Metrics." Referenced via: [NDepend Docs](https://www.ndepend.com/docs/code-metrics)

### Tools Documentation

1. Radon Python Code Metrics. Referenced via: [Radon Documentation](https://radon.readthedocs.io/en/latest/intro.html)

2. Lizard Code Complexity Analyzer. Referenced via: [GitHub](https://github.com/terryyin/lizard)

3. SonarSource Python Rule S3776. Referenced via: [GitHub](https://github.com/SonarSource/sonar-python/blob/master/python-checks/src/main/resources/org/sonar/l10n/py/rules/python/S3776.html)

4. gocyclo - Go Cyclomatic Complexity Calculator. Referenced via: [GitHub](https://github.com/fzipp/gocyclo)

5. eslint-plugin-sonarjs - Cognitive Complexity for JavaScript/TypeScript. Referenced via: [npm](https://www.npmjs.com/package/eslint-plugin-sonarjs)

6. ESLint Complexity Rule. Referenced via: [ESLint Docs](https://eslint.org/docs/latest/rules/complexity)

### Claude Code and Subagent Architecture

1. Alderson, M. (2025). "Solving Claude Code's API Blindness with Static Analysis Tools." Referenced via: [martinalderson.com](https://martinalderson.com/posts/claude-code-static-analysis/)

2. Claude Code Documentation - Create Custom Subagents. Referenced via: [code.claude.com](https://code.claude.com/docs/en/sub-agents)
