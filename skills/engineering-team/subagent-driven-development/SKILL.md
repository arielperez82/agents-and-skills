...
digraph process {
    ...
    "Finish: /review/review-changes then /git/cm or /git/cp" [shape=box style=filled fillcolor=lightgreen];
    ...
    "Dispatch final code reviewer subagent for entire implementation" -> "Finish: /review/review-changes then /git/cm or /git/cp";
}
```
