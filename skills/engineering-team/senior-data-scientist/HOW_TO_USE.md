...
- **feature_engineering_pipeline.py**: Feature Engineering Pipeline
- **model_evaluation_suite.py**: Model Evaluation Suite

You can run these tools directly:

```bash
python skills/engineering-team/senior-data-scientist/scripts/experiment_designer.py --help
```
