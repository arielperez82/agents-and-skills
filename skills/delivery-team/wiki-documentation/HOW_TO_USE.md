# How to Use the Confluence Expert Skill
...
- **space_structure_analyzer.py**: Space Structure Analyzer - Confluence Documentation Analysis Tool

You can run these tools directly:

```bash
python skills/delivery-team/confluence-expert/scripts/space_structure_analyzer.py --help
```
