...
# Product Strategy Session Workflow
...
- Design POC experiments per opportunity solution tree output
...
|  +-- Positioning Workshop (90 min)
|  +-- Proto-Persona (60 min)
|  +-- Jobs-to-be-Done (60 min)
|
+-- Day 3-5: Problem Framing & Validation
|  +-- Problem Framing Canvas (120 min)
|  +-- Problem Statement (30 min)
|  +-- [Optional] Customer Journey Mapping (90 min)
|
...
|  +-- Epic Hypothesis (60 min per epic)
|  +-- [Optional] User Story Mapping (120 min)
|
+-- Decision: Test solutions? (if YES, +1-2 weeks experiments)
|
+-- Day 4-5: Prioritization & Roadmap
   +-- Prioritization Framework (30 min)
   +-- Score & prioritize epics (90 min)
   +-- Sequence roadmap (60 min)
   +-- [Optional] TAM/SAM/SOM (60 min)

Week 3:
+-- Stakeholder Alignment
   +-- [Optional] Press Release (60 min)
   +-- Present strategy (60 min)
   +-- Refine based on feedback (1-2 days)

Week 4:
+-- Execution Planning
   +-- Epic Breakdown (90 min)
   +-- User Stories (30 min per story)
...
**Phase 1:**
- Positioning Workshop (interactive)
...
- Discovery Interview Prep (interactive, if validation needed)

**Phase 3:**
- Opportunity Solution Tree (interactive)
- Lean UX Canvas (interactive, alternative)
...
**Phase 5:**
- Press Release (component, optional)
...
**Phase 1 - Positioning:**
- Ran positioning workshop: Defined target = "non-technical small business owners"
...
- Ran problem framing canvas: Problem = "Users abandon onboarding because jargon-heavy UI and lack guidance"
- Problem statement: "60% of non-technical users drop off in first 24 hours due to overwhelming, unclear onboarding flow"

**Phase 3 - Solution Exploration:**
- Ran opportunity solution tree: Generated 3 opportunities (guidance, simplification, support)
...
- Ran prioritization advisor: Recommended RICE (early PMF stage, some data)
...
**Phase 6 - Execution:**
- Ran epic breakdown advisor: Split "Guided onboarding" using workflow pattern
