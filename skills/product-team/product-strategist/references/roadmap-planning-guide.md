...
**Optional/Related:**
- Product Strategy Session (workflow) — Run before roadmap planning to establish strategy
- Discovery Process (workflow) — Provides customer problem inputs for Phase 1
- User Story Mapping Workshop (interactive) — For complex epics requiring release planning
...
**Phase 3 - Prioritize:**
- Used RICE framework (recommended by prioritization advisor)
