...
Start with the story/epic/feature that needs splitting. Ensure it's written using the user story format.
...
For each split, write a complete user story:
...
```markdown
### Original Story
[Story written with use case and acceptance criteria]
