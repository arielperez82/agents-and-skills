...
## Problem Statement Fill-in Template
...
### Related Skills
- Problem Framing Canvas -- Broader problem exploration before crafting the statement
- Interview Prep Guide -- Gathering user research to inform the statement
- Opportunity Solution Tree -- Using validated problem statements to generate solutions
