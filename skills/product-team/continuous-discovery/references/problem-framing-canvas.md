...
1. **Validate with users:** Use interview prep guide to test reframed problem with customers
2. **Generate solutions:** Use opportunity solution tree to explore solution space
3. **Create problem statement:** Use problem statement template to formalize for PRD/roadmap
...
### Related Skills
- Problem Statement Template -- Converts reframed problem into formal problem statement
- Opportunity Solution Tree -- Uses HMW statement to generate solution options
- Interview Prep Guide -- Validates reframed problem with customers
