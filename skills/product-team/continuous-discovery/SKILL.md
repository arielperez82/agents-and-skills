...
- **Reference:** [problem-framing-canvas.md](references/problem-framing-canvas.md)
...
- **Reference:** [problem-statement-template.md](references/problem-statement-template.md)
- **Participants:** PM
- **Duration:** 30 minutes
...
- **Reference:** [interview-prep-guide.md](references/interview-prep-guide.md)
...
- **Methodology:** From [interview-prep-guide.md](references/interview-prep-guide.md) (Problem validation, JTBD, switch interviews, etc.)
...
- **Top 3-5 pain points:** Prioritized by frequency x intensity x strategic fit
...
- **Reference:** [opportunity-solution-tree.md](references/opportunity-solution-tree.md)
...
|  +-- [Optional] Proto-Persona, Jobs-to-be-Done
|
+-- Day 3: Research Planning
|  +-- Interview Prep Guide (90 min)
...
- Ran Problem Framing Canvas: Problem = "Users abandon onboarding due to lack of guidance"
- Problem statement: "60% of non-technical users drop off in first 24 hours"

**Phase 2 - Research Planning:**
- Ran Interview Prep: Chose "switch interviews" (users who churned)
...
- Ran Opportunity Solution Tree: 3 solutions (guided checklist, tooltips, human onboarding)
...
**Fix:** Use Mom Test questions from [interview-prep-guide.md](references/interview-prep-guide.md) (focus on past behavior)
...
**Phase 1:**
- [Problem Framing Canvas](references/problem-framing-canvas.md) -- MITRE-based problem framing
- [Problem Statement Template](references/problem-statement-template.md) -- empathy-driven problem narrative

**Phase 2:**
- [Interview Prep Guide](references/interview-prep-guide.md) -- discovery interview methodology

**Phase 5:**
- [Opportunity Solution Tree](references/opportunity-solution-tree.md) -- outcome-driven solution mapping
...
This skill consolidates the following reference materials:

| Reference | Description | Source |
|-----------|-------------|--------|
| [problem-framing-canvas.md](references/problem-framing-canvas.md) | MITRE Problem Framing Canvas -- Look Inward, Look Outward, Reframe | Product-Manager-Skills |
| [opportunity-solution-tree.md](references/opportunity-solution-tree.md) | Teresa Torres OST -- outcomes, opportunities, solutions, experiments | Product-Manager-Skills |
| [interview-prep-guide.md](references/interview-prep-guide.md) | Discovery interview preparation -- methodology, questions, bias avoidance | Product-Manager-Skills |
| [problem-statement-template.md](references/problem-statement-template.md) | Empathy-driven problem statement -- I am / Trying to / But / Because / Which makes me feel | Product-Manager-Skills |
