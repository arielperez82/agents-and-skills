...
- **Marginal economics:** LTV:CAC 2-3:1, payback 12-18 months
...
- **Acceptable efficiency:** Rule of 40 25-40, magic number 0.5-0.75, runway 6-12 months
...
|--------|------------------|-----------|--------|
| Growth Rate | ___% | >40% (growth) / >25% (scale) | Healthy |
| NRR | ___% | >100% | Healthy |
| LTV:CAC | ___:1 | >3:1 | Healthy |
| Rule of 40 | ___ | >40 | Healthy |
| Gross Margin | ___% | >70% | Healthy |
...
"## Overall Health: **Moderate** (Fixable Issues)
...
| Dimension | Score | Status |
|-----------|-------|--------|
| **Growth & Retention** | [Healthy / Warning / Critical] | [Details] |
| **Unit Economics** | [Healthy / Warning / Critical] | [Details] |
| **Capital Efficiency** | [Healthy / Warning / Critical] | [Details] |
| **Overall** | **Moderate** | [Primary issue area] needs attention |
...
| Dimension | Score | Status |
|-----------|-------|--------|
| **Growth & Retention** | Critical | [Details] |
| **Unit Economics** | Critical | [Details] |
...
**Metrics:**
- Runway: ___ months to 12+ months
- LTV:CAC: ___:1 to >2:1
- Churn: ___% to reduced by 30%
- NRR: ___% to improving toward 100%
