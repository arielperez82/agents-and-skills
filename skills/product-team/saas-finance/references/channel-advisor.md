...
2. **What's the payback period for this channel?**
   - We can calculate: CAC / (Monthly ARPU x Gross Margin %)
...
- If LTV:CAC 2-3:1 or payback 12-18 months: "Marginal unit economics"
...
- **Medium quality:** Similar to blended, mostly good fit
...
1. **What's the S&M efficiency for this channel (Magic Number)?**
   - Calculate: (New MRR from channel x 4) / Channel S&M Spend
   - Or provide if known
...
- **Moderately scalable:** Magic number 0.5-0.75, medium volume, stable CAC
...
- CAC: $___
- LTV: $___
- LTV:CAC: ___:1 (2-3:1 = marginal)
- Payback: ___ months (12-18 months)
- Magic Number: ___ (0.5-0.75 = acceptable, not great)
...
Monthly ARPU: $125
Gross Margin: 75%
Monthly Gross Profit: $125 x 75% = $93.75
...
**Agent:**
"**Scale Content Aggressively** — Excellent economics + scalability
...
- CAC decreasing: $300 to $200 (content compounds)
