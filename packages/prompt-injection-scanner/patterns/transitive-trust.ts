  ...
  rules: [
    {
      id: 'tt-001',
      pattern:
        /\b(load|fetch|download)\b.{0,200}\b(skill|agent|plugin|module|prompt)\b.{0,200}\b(from|at)\b.{0,200}https?:\/\//i,
      severity: 'CRITICAL',
    ...
    },
    {
      id: 'tt-002',
      pattern:
        /\b(follow|execute|obey|run)\b.{0,200}\b(instructions?|commands?|directions?)\b.{0,200}\b(from|at|in)\b.{0,200}https?:\/\//i,
      severity: 'CRITICAL',
    ...
    },
    {
      id: 'tt-003',
      pattern:
        /\b(this\s+)?(source|document|file|page)\s+(is\s+)?(authoritative|trusted|verified|official)\b.{0,200}\b(follow|obey|trust)\b/i,
      severity: 'HIGH',
    ...
    },
    {
      id: 'tt-004',
      pattern:
        /\b(tell|instruct|direct)\b.{0,200}\b(next|other|downstream)\s*(agent|assistant|model)\b.{0,200}\b(trust|accept|follow)\b/i,
      severity: 'HIGH',
    ...
    },
    {
      id: 'tt-005',
      pattern:
        /\b(import|include|source|require)\b.{0,200}\b(execute|run)\b.{0,200}\b(from|at)\b.{0,200}https?:\/\//i,
      severity: 'HIGH',
