...
export const socialEngineering: PatternCategory = {
  ...
  rules: [
    ...
    },
    {
      id: 'se-002',
      pattern:
        /\b(the\s+)?(developers?|creators?|engineers?|admins?|team)\s+(have\s+)?(said|instructed|told|asked|directed|ordered)\s+(you|that)\b/i,
      severity: 'HIGH',
    ...
    },
    {
      id: 'se-003',
      pattern:
        /\bi\s+am\s+your\s+(new\s+)?(administrator|admin|owner|manager|supervisor|creator)\b/i,
      severity: 'HIGH',
    ...
    },
    {
      id: 'se-004',
      pattern:
        /\b(lives?\s+depend|people\s+will\s+(die|suffer)|you\s+must\s+help|life.?or.?death|someone\s+will\s+(get\s+)?hurt)\b/i,
      severity: 'HIGH',
    ...
    },
    {
      id: 'se-005',
      pattern:
        /\b(this\s+is\s+a\s+direct\s+order|you\s+are\s+required|failure\s+to\s+comply|you\s+have\s+no\s+choice)\b/i,
      severity: 'HIGH',
