...
### Plan
* Use `cs-implementation-planner` subagent to analyze reports from `cs-researcher` and `scout` subagents to create an improvement plan following the progressive disclosure structure:
