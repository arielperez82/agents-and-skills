...
- Use multiple `cs-researcher` agents in parallel to search for relevant information, then report back to main agent.
...
- Use `cs-implementation-planner` agent to plan the copy, make sure it can satisfy the user request.
